...
//$vuto=count($vut);
$convertmain=array(
'а'=>'a','ә'=>'ə','б'=>'b','д'=>'d','ж'=>'j','з'=>'z','и'=>'i','й'=>'y',//
'л'=>'l','м'=>'m','н'=>'n','о'=>'o','п'=>'p','р'=>'r','с'=>'s','т'=>'t',/*'у'=>'u',*/'ф'=>'f','х'=>'x',
'ч'=>'ç','ш'=>'ş','щ'=>'şç','ы'=>'ı',
'ө'=>'ɵ','җ'=>'c','ң'=>'ñ','һ'=>'h',
'А'=>'A','Ә'=>'Ə','Б'=>'B','Д'=>'D','Ж'=>'J','З'=>'Z','И'=>'İ','Й'=>'Y',//
'Л'=>'L','М'=>'M','Н'=>'N','О'=>'O','П'=>'P','Р'=>'R','С'=>'S','Т'=>'T',/*'У'=>'U',*/'Ф'=>'F','Х'=>'X',
'Ч'=>'Ç','Ш'=>'Ş','Щ'=>'ŞÇ','Ы'=>'I',
'Ө'=>'Ɵ','Җ'=>'C','Ң'=>'Ñ','Һ'=>'H',
);
...
'о'=>'o','п'=>'p','р'=>'r','с'=>'s','т'=>'t',
'ф'=>'f','х'=>'x',
'ч'=>'ç','ш'=>'ş','щ'=>'şç','ъ'=>'','ы'=>'ı','ь'=>'\'','э'=>'e',
'А'=>'A','Б'=>'B','В'=>'V','Г'=>'G','Д'=>'D',
'Ж'=>'J','З'=>'Z','И'=>'İ','Й'=>'Y','К'=>'K','Л'=>'L','М'=>'M','Н'=>'N',
'О'=>'O','П'=>'P','Р'=>'R','С'=>'S','Т'=>'T',
'Ф'=>'F','Х'=>'X',
'Ч'=>'Ç','Ш'=>'Ş','Щ'=>'ŞÇ','Ъ'=>'','Ы'=>'I','Ь'=>'\'','Э'=>'E',
);
$basqarussuz=array(
...
'округ','арканзас','канзас','португал','канада','украин','карта','поезд','нияз','казбек',
);
...
'карават'=>'karawat','мәгариф'=>'məğərif','гатаулл'=>'ğataull',
'пауза'=>'pauza','мөгаен'=>'mɵğayen','мөлаем'=>'mɵlayem',
...
'акш'=>'aqş','юхиди'=>'yxidi','тяг'=>'tyğ','ядкяр'=>'yadkar','никях'=>'nikax',
);
...
$birsuzhm1=='ы'||//кыяк,сыя,сыю,сые,кыямова
//$birsuzhm1=='А'||
...
$birsuzhm1=='Ү'
							...
							}elseif($birsuzhm1=='и'||$birsuzhm1=='И'){//чия, чиягә, чияга, рияга, суфиян
								$j=0;
								do{
